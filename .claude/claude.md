...
3. **After completing work**: Update PROGRESS.md with session notes
4. **When making mistakes**: Add to QUICK_REF.md "Mistakes to Avoid"
5. **End of significant sessions**: Write a blog entry in BLOG.md reflecting on what was accomplished, challenges faced, and insights gained
